...
#define N 1000 // Esto define la cantidad de elementos en los arreglos. Puedes cambiarlo para probar con más o menos datos.
...
#pragma omp parallel for shared(a, b, c) private(i)
    ...
    std::cout << "Arreglo C (Resultado): "; imprimeArreglo(c, MOSTRAR);
